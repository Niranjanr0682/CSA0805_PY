...
def is_id_unique(resource_id, resource_type): #for uniqueness
...
def add_resource_data(resource_type, resource_id, name, quantity, status): #to add
...
def update_resource_data(resource_type, name, quantity, status): #to change
    for resource in resources[resource_type]:
...
def remove_resource(resource_type, name):#to remove
    global resources
...
def search_resource(name):# to search
    found = False
    for resource_type, resource_list in resources.items():
        for resource in resource_list:
            if resource['name'] == name:
...
def display_resources(): #to display
    print("╔══════════════════════════════════════════════════════════════════════╗")
    ...
    print("╠══════════════════════════════════════════════════════════════════════╣")
    for resource_type, resource_list in resources.items():
        print(f"║ {resource_type.capitalize()} resources:{"":<50}║")
        for resource in resource_list:
            print(f"║ {resource_type[:1].upper():<6} ║ {resource['id']:4d} ║ {resource['name'][:20]:<19} ║ {resource['quantity']:8} ║ {resource['status'][:20]:<19} ║")
        print("╠══════════════════════════════════════════════════════════════════════╣")
    print("╚══════════════════════════════════════════════════════════════════════╝")
